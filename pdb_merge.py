...
# Modifications:
# - run function ignores MASTER, ENDMDL and END records.
# - ENDMDL and END are appended to the end of the output.
...
def run(flist):
    ...
    """
    # modifications below to exclude lines with END and ENDMDL
    ignored = ('MASTER', 'ENDMDL', 'END')
